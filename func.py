...
def submit_dates():
    ...
    #          label="Фактические значения Общестроительные работы")
    # plt.plot(X["Месяц строительства "], Y["Тепломонтажнные работы "],
    #          label="Фактические значения Тепломонтажнные работы ")
...
#_________________________Количество рабочих по странам от этапов 1____________________________________________
    ...
    # ____________________________________________________________________
    # plt.plot(X["Месяц строительства "], ypred[:, 0], label="Прогноз Общестроительные работы")
    # plt.plot(X["Месяц строительства "], ypred[:, 1], label="Прогноз Общестроительные работы")
    # plt.plot(X["Месяц строительства "], ypred[:, 2], label="Прогноз Общестроительные работы")
    # plt.plot(X["Месяц строительства "], ypred[:, 3], label="Прогноз Общестроительные работы")
    # plt.plot(X["Месяц строительства "], ypred[:, 4], label="Прогноз Общестроительные работы")
    # plt.plot(X["Месяц строительства "], ypred[:, 5], label="Прогноз Общестроительные работы")
    # plt.plot(X["Месяц строительства "], ypred[:, 6], label="Прогноз Общестроительные работы")
...
data = pd.read_excel('graphs.xlsx')
#____________________________Работает__________________________________________________________________________
X = data[["Месяц строительства ", "year "]]  # Выбираем признаки
Y = data[["Общестроительные работы", "Тепломонтажнные работы ", "Электромонтажные работы ",
          "Общестроительные работы1", "Тепломонтажнные работы1", "Электромонтажные работы1",
          "Общестроительные работы12", "Тепломонтажнные работы12", "Электромонтажные работы12"]]
tscv = TimeSeriesSplit(n_splits=10)
...
plt.plot(X["Месяц строительства "], Y["Общестроительные работы"], label="Фактические значения Общестроительные работы")
plt.plot(X["Месяц строительства "], Y["Общестроительные работы1"], label="Фактические значения Общестроительные работы1")
plt.plot(X["Месяц строительства "], Y["Общестроительные работы12"], label="Фактические значения Общестроительные работы12")
plt.plot(X["Месяц строительства "], ypred[:, 0], label="Прогноз Общестроительные работы")
plt.plot(X["Месяц строительства "], ypred[:, 0], label="Прогноз Общестроительные работы")
plt.plot(X["Месяц строительства "], ypred[:, 1], label="Прогноз Общестроительные работы")
plt.plot(X["Месяц строительства "], ypred[:, 2], label="Прогноз Общестроительные работы")
...
plt.ylabel('Общестроительные работы')
